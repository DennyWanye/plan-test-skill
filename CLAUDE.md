...
**总计诊断码**: 56 个（以 `CANONICAL_ORDER` 为准；实测 `len(CANONICAL_ORDER)`，勿手数。
2026-08-29 W6：+3（FLOW_TIER_UNDECLARED/FLOW_TIER_BASIS_FALSE/PHASE_TELEMETRY_MISSING，登记见 PROTOCOL §4b）。
